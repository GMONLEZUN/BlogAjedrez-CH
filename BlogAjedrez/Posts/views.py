...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            mensaje = "Error: Revisá el correo 'example@example.com'. Revisá la contraseña, no debe ser similar al usuario, debe tener 8 caracteres, y uno debe ser mayúscula"
            return render(request,'Posts/registro.html',{"mensaje":mensaje, "form":form})
    else:
...
def handler400(request,exception):
    return render(request, 'Posts/400.html', status=400)
